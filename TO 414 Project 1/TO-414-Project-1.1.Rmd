...
filter(hotel_data, is_repeated_guest == 1) %>%
  select(is_repeated_guest, previous_bookings_not_canceled, previous_cancellations, total_reservations) #This needs to be removed, it is 3800 lines when we knit
```
